...
public class VentanaFabricantes implements ChangeListener, ItemListener   {
	...
	private JRadioButton jrbtnUno;
	private JRadioButton jrbtnDos;
	...
	private void initialize() {
		...
		comboBox1.addItemListener((ItemListener) this);

		ButtonGroup bg = new ButtonGroup();
		jrbtnUno = new JRadioButton("Uno");

		panel.add(jrbtnUno);
		bg.add(jrbtnUno);

		jrbtnDos = new JRadioButton("Dos");

		panel.add(jrbtnDos);
		bg.add(jrbtnDos);

		jrbtnUno.addChangeListener((ChangeListener) this);
		jrbtnDos.addChangeListener((ChangeListener) this);
	}
